...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ContentSection.type'
        db.alter_column(u'ahjodoc_contentsection', 'type', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'ContentSection.type'
        db.alter_column(u'ahjodoc_contentsection', 'type', self.gf('django.db.models.fields.CharField')(max_length=20))
