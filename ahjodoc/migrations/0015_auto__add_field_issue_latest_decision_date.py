...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.latest_decision_date'
        db.add_column(u'ahjodoc_issue', 'latest_decision_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Issue.latest_decision_date'
        db.delete_column(u'ahjodoc_issue', 'latest_decision_date')
