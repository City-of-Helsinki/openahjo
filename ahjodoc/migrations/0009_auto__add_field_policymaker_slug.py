...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Policymaker.slug'
        db.add_column(u'ahjodoc_policymaker', 'slug',
                      self.gf('django.db.models.fields.CharField')(max_length=50, unique=True, null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Policymaker.slug'
        db.delete_column(u'ahjodoc_policymaker', 'slug')
