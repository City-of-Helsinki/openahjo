...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AgendaItem.last_modified_time'
        db.alter_column(u'ahjodoc_agendaitem', 'last_modified_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
        # Adding field 'Policymaker.summary'
        db.add_column(u'ahjodoc_policymaker', 'summary',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'AgendaItem.last_modified_time'
        db.alter_column(u'ahjodoc_agendaitem', 'last_modified_time', self.gf('django.db.models.fields.DateTimeField')())
        # Deleting field 'Policymaker.summary'
        db.delete_column(u'ahjodoc_policymaker', 'summary')
