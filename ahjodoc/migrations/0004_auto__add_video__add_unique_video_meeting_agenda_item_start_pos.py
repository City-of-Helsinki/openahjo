...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Video'
        db.create_table(u'ahjodoc_video', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('meeting', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ahjodoc.Meeting'])),
            ('agenda_item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ahjodoc.AgendaItem'], null=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('index', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('start_pos', self.gf('django.db.models.fields.FloatField')()),
            ('duration', self.gf('django.db.models.fields.FloatField')()),
            ('speaker', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('party', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('screenshot', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal(u'ahjodoc', ['Video'])

        # Adding unique constraint on 'Video', fields ['meeting', 'agenda_item', 'start_pos']
        db.create_unique(u'ahjodoc_video', ['meeting_id', 'agenda_item_id', 'start_pos'])


    def backwards(self, orm):
        # Removing unique constraint on 'Video', fields ['meeting', 'agenda_item', 'start_pos']
        db.delete_unique(u'ahjodoc_video', ['meeting_id', 'agenda_item_id', 'start_pos'])

        # Deleting model 'Video'
        db.delete_table(u'ahjodoc_video')
    ...
    models = {
        ...
        u'ahjodoc.video': {
            ...
            'speaker': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True'}),
