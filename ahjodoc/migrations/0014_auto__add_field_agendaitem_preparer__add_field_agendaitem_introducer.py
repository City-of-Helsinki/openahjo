...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AgendaItem.preparer'
        db.add_column(u'ahjodoc_agendaitem', 'preparer',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'AgendaItem.introducer'
        db.add_column(u'ahjodoc_agendaitem', 'introducer',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AgendaItem.preparer'
        db.delete_column(u'ahjodoc_agendaitem', 'preparer')

        # Deleting field 'AgendaItem.introducer'
        db.delete_column(u'ahjodoc_agendaitem', 'introducer')
