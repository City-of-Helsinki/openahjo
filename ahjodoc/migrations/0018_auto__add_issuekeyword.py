...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ahjodoc_issuekeyword', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=150, db_index=True)),
        ))
        db.send_create_signal(u'ahjodoc', ['IssueKeyword'])

        # Adding M2M table for field keywords on 'Issue'
        m2m_table_name = db.shorten_name(u'ahjodoc_issue_keywords')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('issue', models.ForeignKey(orm[u'ahjodoc.issue'], null=False)),
            ('issuekeyword', models.ForeignKey(orm[u'ahjodoc.issuekeyword'], null=False))
        ))
        db.create_unique(m2m_table_name, ['issue_id', 'issuekeyword_id'])


    def backwards(self, orm):
        # Deleting model 'IssueKeyword'
        db.delete_table(u'ahjodoc_issuekeyword')

        # Removing M2M table for field keywords on 'Issue'
        db.delete_table(db.shorten_name(u'ahjodoc_issue_keywords'))
