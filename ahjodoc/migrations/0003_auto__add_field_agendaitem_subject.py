...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AgendaItem.subject'
        db.add_column(u'ahjodoc_agendaitem', 'subject',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AgendaItem.subject'
        db.delete_column(u'ahjodoc_agendaitem', 'subject')
