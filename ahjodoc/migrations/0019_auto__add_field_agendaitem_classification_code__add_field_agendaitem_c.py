...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AgendaItem.classification_code'
        db.add_column(u'ahjodoc_agendaitem', 'classification_code',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True),
                      keep_default=False)

        # Adding field 'AgendaItem.classification_description'
        db.add_column(u'ahjodoc_agendaitem', 'classification_description',
                      self.gf('django.db.models.fields.CharField')(max_length=60, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AgendaItem.classification_code'
        db.delete_column(u'ahjodoc_agendaitem', 'classification_code')

        # Deleting field 'AgendaItem.classification_description'
        db.delete_column(u'ahjodoc_agendaitem', 'classification_description')


    models = {
        u'ahjodoc.agendaitem': {
            'Meta': {'ordering': "('meeting', 'index')", 'unique_together': "(('meeting', 'issue'), ('meeting', 'index'))", 'object_name': 'AgendaItem'},
            'classification_code': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'}),
            'classification_description': ('django.db.models.fields.CharField', [], {'max_length': '60', 'null': 'True'}),
            'from_minutes': ('django.db.models.fields.BooleanField', [], {}),
        ...
        u'ahjodoc.issue': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'keywords': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['ahjodoc.IssueKeyword']", 'symmetrical': 'False'}),
        ...
        u'ahjodoc.meeting': {
            ...
            'minutes': ('django.db.models.fields.BooleanField', [], {}),
            'number': ('django.db.models.fields.PositiveIntegerField', [], {}),
