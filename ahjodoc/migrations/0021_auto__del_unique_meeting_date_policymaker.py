...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Meeting', fields ['date', 'policymaker']
        db.delete_unique(u'ahjodoc_meeting', ['date', 'policymaker_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'Meeting', fields ['date', 'policymaker']
        db.create_unique(u'ahjodoc_meeting', ['date', 'policymaker_id'])
    ...
    models = {
        ...
        u'ahjodoc.issue': {
            ...
            'reference_text': ('django.db.models.fields.TextField', [], {'null': 'True'}),
        ...
        u'ahjodoc.meeting': {
            'Meta': {'unique_together': "(('policymaker', 'year', 'number'),)", 'object_name': 'Meeting'},
