...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.reference_text'
        db.add_column(u'ahjodoc_issue', 'reference_text',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Issue.reference_text'
        db.delete_column(u'ahjodoc_issue', 'reference_text')
