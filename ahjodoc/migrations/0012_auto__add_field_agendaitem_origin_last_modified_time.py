...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AgendaItem.origin_last_modified_time'
        db.add_column(u'ahjodoc_agendaitem', 'origin_last_modified_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True),
                      keep_default=False)

        # Adding M2M table for field districts on 'Issue'
        m2m_table_name = db.shorten_name(u'ahjodoc_issue_districts')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('issue', models.ForeignKey(orm[u'ahjodoc.issue'], null=False)),
            ('district', models.ForeignKey(orm[u'munigeo.district'], null=False))
        ))
        db.create_unique(m2m_table_name, ['issue_id', 'district_id'])


    def backwards(self, orm):
        # Deleting field 'AgendaItem.origin_last_modified_time'
        db.delete_column(u'ahjodoc_agendaitem', 'origin_last_modified_time')

        # Removing M2M table for field districts on 'Issue'
        db.delete_table(db.shorten_name(u'ahjodoc_issue_districts'))
