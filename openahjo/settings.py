# Django settings for openahjo project.
import os.path
...
DATABASES = {
    'default': {
        ...
        'NAME': 'openahjo',                      # Or path to database file if using sqlite3.
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'openahjo-locmem-cache',
        'KEY_PREFIX': 'openahjo-'
    }
}
...
SECRET_KEY = '*b91nsmwlxsd3dq7z-#&za9(*qe83qm6kl9fh%mghivrq_a8b-'
